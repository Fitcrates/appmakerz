    ...
    >
      ...
      <div className="max-w-7xl mx-auto mb-16 px-4 sm:px-6 lg:px-8 mt-4">
        ...
        <div className="text-left text-4xl sm:text-6xl mb-16 tracking-wide ">
          <span className="text-white font-biglight font-jakarta">{t.heading.part1}</span>{' '}
          <span className="text-teal-300 font-biglight font-jakarta">{t.heading.part2}</span>{' '}
          <span className="text-white font-biglight font-jakarta">{t.heading.part3}</span>{' '}
        </div>
