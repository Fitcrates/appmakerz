...
const ServicesNew: React.FC = () => {
  ...
  return (
    <section id="services" ref={containerRef} className="relative py-20 lg:py-24 bg-indigo-950 overflow-visible">
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div className="lg:flex lg:items-center">
            <motion.div ref={imageRef} style={{ y: imageY, willChange: 'transform' }} className="relative w-full aspect-[4/5]">
              <CrackImage
              ...
              <motion.div
                ...
                aria-hidden="true"
                animate={{ height: [64, 96, 64], opacity: [0.3, 0.5, 0.3] }}
