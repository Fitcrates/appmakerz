    ...
    >
      ...
      >
        ...
        <div className="mb-8" aria-hidden="true">
          <BurnSpotlightText
            as="div"
            className="text-3xl sm:text-7xl lg:text-[120px] font-light font-jakarta tracking-normal leading-[1.2]"
            glowSize={200}
            baseDelay={500}
            charDelay={40}
            activateOnMount
        ...
        >
          <SpotlightText
            as="p"
            className="text-lg sm:text-xl font-jakarta font-light"
            glowSize={100}
          >
            {t.subtitle}
          </SpotlightText>
      ...
      />
      <div
        className="absolute bottom-8 right-8 w-16 h-16 border-r border-b border-white/10 z-10"
        aria-hidden="true"
      />
    </section>
  );
