...
const Hero = () => {
  ...
  return (
    <section className="hero-section min-h-screen h-screen w-full flex items-end pb-20 overflow-x-hidden">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center lg:items-end w-full">
          ...
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
            {[t.title.line1, t.title.line2, t.title.line3].map((line, index) => (
              <h1
                key={index}
                className="text-5xl sm:text-7xl md:text-8xl font-light text-white tracking-tight font-jakarta font-normal leading-none  -mt-1"
              >
                {line}
              </h1>
            ))}
