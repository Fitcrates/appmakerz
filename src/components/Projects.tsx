        ...
        >
          ...
          >
            ...
            <div className="h-3/5 p-6 flex flex-col relative">
              ...
              <p className="text-white mt-8 font-jakarta font-light leading-relaxed text-sm z-10">
          ...
          >
            ...
            <div className="h-3/5 p-6 flex flex-col relative">
              ...
              <p className="text-white mt-8 font-jakarta font-light leading-snug text-sm z-10">
